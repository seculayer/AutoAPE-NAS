...
def train(sents, mask, labels, output_dir, num_layers, embedding, pre_idxs=[]):
  ...
  print("Child Model has {} params".format(num_vars))
  if controller_model is not None:
    num_vars2 = count_model_params(controller_model.parameters())
    print("Controller Model has {} params".format(num_vars2))
  ...
  for epoch in range(start_epoch, FLAGS.num_epochs):
    ...
    if controller_model is None:
      ...
      print("ch_step={} {}_accuracy={:<6.4f} {}_loss={:<6.4f} {}={:.2f}".format(
          step, "test", eval_acc, "test", eval_loss, "sec", total_test_time))
  ...
  total_search_time = total_end_time - total_start_time
  print("총 훈련 시간: {:.2f}초".format(total_search_time))
