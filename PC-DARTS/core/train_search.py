...
flags.DEFINE_string('cfg_path', '../configs/pcdarts_cifar_search.yaml',
                    'config file path')
...
def main(_):
    ...
    # define training step function for model(epoch<=15)
    @tf.function
    ...
    # define training step function for arch_parameters(epoch>15)
    @tf.function
